-- Active: 1740077526153@@127.0.0.1@3306@flipkart
USE sqllearning;
...
-- ------------------ SELF JOINS -----------------------------------------------------
select * FROM users1;
SELECT u1.user_id,u1.name,u2.emergency_contact AS emergency_contact_id ,u2.name 
AS emergency_contact_name 
FROM users1 u1 
JOIN users1 u2 ON u1.user_id=u2.emergency_contact;
