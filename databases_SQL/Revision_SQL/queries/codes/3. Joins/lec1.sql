...
-------------------------------------------------------------------------INNER JOIN--------------------------------------------------------------------------------------------------------------------------------------------
-- in sql, inner join is atype of join operation data from two or more tables based on a speicific condition
...
SELECT * FROM `groups`;
-- ---------------------------------------------------------------------CROSS JOINS ---------------------------------------------------------------------------------------------------------------------------------------
SELECT * FROM users1 t1 CROSS JOIN `groups` t2; 
-- ---------------------------------------------------------------------INNER JOINS------------------------------------------------------------------------------------------------------------------------------------------
...
-- ----------------------------------------------------------------FULL OUTER JOINS------------------------------------------------------------------------------------------------------------------------------------
SELECT * FROM users1 FULL JOIN membership ;
-- -----------------------------------------------------------------------SETS------------------------------------------------------------------------------------------------------------------------------------------------
-- -----------------------------------------------------------------------UNION------------------------------------------------------------------------------------------------------------------------------------------------
SELECT * FROM person2;
SELECT * FROM person1
...
-- Why FULL JOIN is Better:
-- Efficiency: FULL JOIN directly combines both tables in a single operation.
-- Readability: FULL JOIN is more intuitive and clear for this scenario

-- -----------------------------------------------------------------------------------------------------------------------------------------------------------------------
-- ----------------------------------------------------------------------SELF JOINS -----------------------------------------------------------------------------------------------------------------------------------------
SELECT u1.user_id,u1.name,u2.emergency_contact AS emergency_contact_id ,u2.name AS emergency_contact_name 
FROM users1 u1 
JOIN users1 u2 
